# Learning Playwright — JavaScript Fundamentals

A structured series of JavaScript practice exercises organized by topic, building from core language concepts up to user input handling.
...
Supplementary concept reference cards stored in `IQ_Notes/`:

| File | Topic |
|------|-------|
| `01_Source_Code_ByteCode_Binary_IQ.md` | Source code → bytecode → binary pipeline |
| `02_Keyword.md` | JavaScript keywords reference |
| `03_Commands.md` | Cross-platform command reference |
| `03_Commands_Mac.md` | macOS-specific terminal commands |
| `03_Commands_Windows.md` | Windows-specific terminal commands |
